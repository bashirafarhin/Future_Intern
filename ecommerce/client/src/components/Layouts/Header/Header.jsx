      ...
      <div className="w-full sm:w-full lg:w-9/12 px-1 sm:px-4 m-auto flex justify-between items-center relative">
        ...
        <div className="flex items-center flex-1 ">
          <Link className="h-7 mr-1 sm:mr-4" to="/">
            {/* <img loading="lazy" draggable="false" className="h-full w-full object-contain" src={logo} alt="LocaMart Logo" /> */}
            <p className="h-full w-full text-white font-dancing text-3xl font-bold">LocalMart</p>
          </Link>
